...
import (
	...
	groupServer "github.com/lambertstu/shortlink-user-rpc/internal/server/group"
	userServer "github.com/lambertstu/shortlink-user-rpc/internal/server/user"
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		...
		user.RegisterGroupServer(grpcServer, groupServer.NewGroupServer(ctx))
